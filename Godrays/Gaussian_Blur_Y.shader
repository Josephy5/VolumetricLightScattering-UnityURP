Shader "Hidden/Gaussian_Blur_Y"
{
     SubShader
     {
        Pass
        {
            ...
            Cull Off ZWrite Off ZTest Always Blend [_BlendSrc] [_BlendDst]
            ...
            //apply gaussian blur on y cords in accordance with depth
            float4 frag(Varyings input) : SV_Target
            {
                ...
                {
                    float2 uv = input.uv + float2(0.f, index * _MainTex_TexelSize.y * _GaussAmount);
